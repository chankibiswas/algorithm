...
(we get two strings of 13 and 2). Finally we connect 13 and 2. Total cost in this way is 10 + 13 + 15 = 38.
 */
public class ConnectRopesWithMinimumCost {

    public static void main(final String[] s) {
        final int[] arr = {1, 2, 6, 8, 4, 5};
        new ConnectRopesWithMinimumCost().printMinimumCostOfConnectingRopes(arr);
    }

    private void printMinimumCostOfConnectingRopes(final int[] arr) {
